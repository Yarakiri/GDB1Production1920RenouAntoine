...
create(){
	...
	this.button.on('pointerdown', function(){this.scene.start("map4");}, this)

	this.button = this.add.image(270, 180, 'buttzone5').setInteractive();
	this.button.on('pointerdown', function(){this.scene.start("map5");}, this)

	this.button = this.add.image(1230, 520, 'buttzone6').setInteractive();
	this.button.on('pointerdown', function(){this.scene.start("map6");}, this)
}
